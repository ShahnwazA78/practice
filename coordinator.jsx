...
const AWVMemberDetailsCoodinator = (props) => {
    ...
    useEffect(() => {
        ...
        if (editFormData?.awe_source && editFormData?.awe_source != '') {
            ...
            setValue('receiver_date', Moment(editFormData?.receiver_date).format("YYYY-MM-DD"));
            ...
            <div class="awv-recored-right-sidebar-form">
                {isLoading == false ?
                    <form onSubmit={handleSubmit(onSubmit)} id="add-verification-model">
                        ...
                        <div className="col-lg-12 align-items-center mb-3 mt-3">
                            ...
                            <FormControl fullWidth margin="dense" variant="outlined" style={{ 'min-width': '200px' }}>
                                ...
                                <Controller
                                    className="input-control"
                                    name="receiver_date"
                                    value={Moment(editFormData?.receiver_date).format("YYYY-MM-DD")}
                                    control={control}
                                    render={({ field }) => (
                        ...
                        <div className="col-lg-12 align-items-center mb-3 mt-3">
                            <div className='mb-1'><strong>Rendering Provider</strong></div>
                            <FormControl fullWidth margin="dense" variant="outlined" style={{ 'min-width': '200px' }}>
                                {/* <InputLabel id="demo-simple-select-outlined-label">User Name</InputLabel> */}
                                <Controller
                                    className="input-control"
                                ...
                                />
                                {errors?.rendering_provider?.type === "required" && <label className="text-danger">This field is required</label>}
                            </FormControl>
                        </div>
                        {/* autopopulate fields */}
                        <div className="col-lg-12 align-items-center mb-3 mt-3">
                            <div className='mb-1'><strong>HCC CODE <span style={{ color: 'red' }}> *</span></strong></div>
                            <FormControl fullWidth margin="dense" variant="outlined" style={{ 'min-width': '200px' }}>
                                {/* <InputLabel id="demo-simple-select-outlined-label">User Name</InputLabel> */}
                                <Controller
                                    className="input-control"
                                    ...
                                    render={({ field }) => (
                                        ...
                                        <Autocomplete
                                            ...
                                            options={hccData}
                                            sx={{ width: 300 }}
                                            renderInput={(params) => <TextField {...params} value={hccValue}
                                                inputProps={{
                                                    ...params.inputProps,
                        ...
                        <div className="col-lg-12 align-items-center mb-3">
                            <div className='mb-1'><strong>HCC DESCRIPTION <span style={{ color: 'red' }}> *</span></strong></div>
                            <FormControl fullWidth margin="dense" variant="outlined" style={{ 'min-width': '200px' }}>
                                {/* <InputLabel id="demo-simple-select-outlined-label">User Name</InputLabel> */}
                                <Controller
                                    className="input-control"
                                    ...
                                    control={control}
                                    render={({ field }) => (
                                        <TextField  {...field} variant="outlined" value={inputValueHCCDescription} required />
                                    )}
                                /*  rules={{
                                     required: false,                      
                                 }} */
                        ...
                        <div className="col-lg-12 align-items-center mb-3 mt-3">
                            <div className='mb-1'><strong>SiteID</strong></div>
                            <FormControl fullWidth margin="dense" variant="outlined" style={{ 'min-width': '200px' }}>
                                {/* <InputLabel id="demo-simple-select-outlined-label">User Name</InputLabel> */}
                                <Controller
                                    className="input-control"
